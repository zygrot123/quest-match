...
const ALL_TIPS: Tip[] = [
  ...
  {
    id: 'special-arrow-gem',
    category: 'Special Gems',
    icon: '🏹',
    title: 'Arrow Gems (4-Gem Match)',
    description: 'Match 4 gems to create an Arrow Gem. Match it in a 3-combo with gems of the same element to unleash a piercing laser blast across that entire row or column!',
    badgeColor: 'border-yellow-500/50 bg-yellow-950/60 text-yellow-300',
  },
  {
    id: 'special-cross-bomb',
    category: 'Special Gems',
    icon: '💣',
    title: 'Cross Bomb & Rainbow Star',
    description: 'Match 5 gems in a line for a Rainbow Star, or form a T/L intersection for a Cross Bomb. Detonating clears massive rows & columns!',
    badgeColor: 'border-orange-500/50 bg-orange-950/60 text-orange-400',
  },
  {
    id: 'special-combos',
    category: 'Special Gems',
    icon: '✨',
    title: 'Special Gem Combos',
    description: 'Swap two Special Gems together (Arrow + Arrow, Arrow + Bomb, or Rainbow + Special) to trigger satisfying mega cross detonations!',
  ...
  {
    id: 'rune-seals-blocks',
    category: 'Combat & Combos',
    icon: '🔮',
    title: 'Arcane Rune Seals',
    description: 'Match gems adjacent to translucent Rune Seals to crack and shatter them. Cleansing all seals in a stage unlocks the Rune Vault for massive damage and gold!',
  ...
  },
  {
    ...
    category: 'Special Gems',
    icon: '⚡',
    title: 'Relic Nova (50 Steps Across Stages)',
    description: 'Charges by 1 step per valid move across all stages (50 steps to reach 100%). Unleash it to crack active Rune Seals, deal heavy burst damage, and forge a special bomb gem!',
    badgeColor: 'border-yellow-500/50 bg-yellow-950/60 text-yellow-300',
  },
];
